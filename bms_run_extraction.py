...
def main() -> None:
    ...
    magazine_dir = Path(r"C:\BMS_C_Locatie\AI_Project\Magazine_test_location")   #locatie Aanpassen naar eigen voorkeur
    base_output_dir = Path(r"C:\BMS_C_Locatie\AI_Project\XML_test")  
